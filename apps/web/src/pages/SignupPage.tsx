  ...
  return (
    <main className="premium-section max-w-md">
      <form className="glass-card space-y-4 rounded-2xl p-6" onSubmit={onSubmit}>
        ...
        <button className="w-full rounded-lg bg-violet-500 py-2 font-medium" type="submit">Sign up</button>
        <p className="text-sm text-slate-300">Already have an account? <Link to="/login" className="text-violet-300">Login</Link></p>
      </form>
    </main>
  );
};
